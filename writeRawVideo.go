...
func main() {
	ffplay := exec.Command("./ffplay", "-i", "pipe:0", "-pix_fmt", "bgr24", "-s", strconv.Itoa(100)+"x"+strconv.Itoa(80), "-f", "rawvideo") //nolint
	...
	for i := 0; i < frameCount; i++ {
		...
		addLabel(img, 30, 20, fmt.Sprintf("%d", i/24))
